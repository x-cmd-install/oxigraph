...
[![x-cmd/install — oxigraph Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/oxigraph.svg?lang=zh)](https://x-cmd.com/install/oxigraph)
...
合计: **85,794** 行代码（覆盖前 5 种语言、共 **205** 个文件）。
...
- **上游仓库**: <https://github.com/oxigraph/oxigraph>
- **许可证**: Apache-2.0
...
- **Star**: 1,947 · **Fork**: 178 · **开放 issue**: 395 · **贡献者**: 39

## 累计统计

- **发布数**: 77 · **已合并 PR**: 1161 · **开放 PR**: 21 · **已关闭 issue**: 265 · **开放 issue**: 130 · **提交数**: 2406

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 2 | 47 | 5 | 5 | 5 | 42 |
| last60d | 2026-07-26 | 2 | 79 | 8 | 17 | 16 | 82 |
| 90d | 2026-06-26 | 2 | 110 | 8 | 25 | 19 | 106 |
| last180d | 2026-03-28 | 5 | 179 | 12 | 30 | 27 | 177 |
| 360d | 2025-09-29 | 12 | 280 | 15 | 44 | 42 | 293 |
| last720d | 2024-10-04 | 29 | 540 | 19 | 89 | 66 | 609 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/oxigraph.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:50:07Z._
